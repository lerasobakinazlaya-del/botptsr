...
<body>
  ...
  <script>
    ...
    function renderOverview(){
      ...
      $('#overview-cards').innerHTML += [`<div class="card"><div class="stat-label">\u0412\u0438\u0440\u0442\u0443\u0430\u043b\u044c\u043d\u044b\u0435 \u043e\u043f\u043b\u0430\u0442\u044b</div><div class="stat-value">${virtualProvider.successful_payments??0}</div><div class="muted">\u0412\u044b\u0440\u0443\u0447\u043a\u0430: ${virtualProvider.revenue??0}</div></div>`,`<div class="card"><div class="stat-label">Telegram \u043e\u043f\u043b\u0430\u0442\u044b</div><div class="stat-value">${telegramProvider.successful_payments??0}</div><div class="muted">\u0412\u044b\u0440\u0443\u0447\u043a\u0430: ${telegramProvider.revenue??0}</div></div>`].join('');
      $('#recent-users').innerHTML=recentUsersTable(recent.users||[]);
      $('#recent-payments').innerHTML=table(['user_id','provider','package_title','amount','currency','status','virtual_payment','event_time'],recent.payments||[]);
