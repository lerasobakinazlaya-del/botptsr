...
def _prepare_test_context(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    memory_context = container.ai_service._build_memory_context(updated_state)  # noqa: SLF001
