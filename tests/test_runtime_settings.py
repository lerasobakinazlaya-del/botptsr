...
class RuntimeSettingsRegressionTests(unittest.TestCase):
    def test_public_runtime_copy_is_human_readable(self):
        ...
        self.assertIn("план", payment["buy_cta_text"].lower())
        ...
        self.assertIn("платные планы", payment["premium_menu_description_template"].lower())
        ...
        self.assertNotIn("Premium на 30 дней", payment["offer_cta_text_a"])
        self.assertNotIn("Premium уже активен", payment["success_message"])
        self.assertEqual("Оплата прошла успешно. Доступ активен.", payment["success_message"])
        self.assertEqual("gpt-5.4-mini", runtime["ai"]["plan_overrides"]["free"]["model"])
        self.assertEqual("gpt-5.4-mini", runtime["ai"]["plan_overrides"]["pro"]["model"])
        self.assertEqual("gpt-5.4", runtime["ai"]["plan_overrides"]["premium"]["model"])
