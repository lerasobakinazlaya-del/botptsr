...
- Аватар: использовать `assets/nit-avatar.png`.
- Первый промо-визуал: использовать `assets/launch-card.png`; `assets/launch-card.svg` хранить как редактируемый исходник.
