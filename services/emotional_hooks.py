...
HOOK_LIBRARY: dict[str, tuple[str, ...]] = {
    ...
    "escalation_hooks": (
        "и следующий ход лучше делать уже конкретнее",
        "но сейчас важнее не растягивать интригу, а попасть в точку",
        "и здесь просится не новый вопрос, а ясный следующий шаг",
        "но дальше это должно становиться полезнее, а не туманнее",
        "и тут лучше держать живой темп, без лишней драматизации",
        "и это место стоит развернуть по делу",
    ),
