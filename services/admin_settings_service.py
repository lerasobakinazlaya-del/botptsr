...
class AdminSettingsService:
    ...
    DEFAULT_RUNTIME_SETTINGS = {
        ...
        "ui": {
            ...
            "modes_menu_premium_text": "Premium открывает все платные режимы: {premium_modes_list}.\nЦена: {price_label} на {access_days_label}.",
            "modes_menu_preview_text": "Сейчас без подписки можно попробовать: {preview_modes_list}.",
            "modes_menu_active_premium_text": "У тебя активен Premium. Доступны все режимы из каталога.",
