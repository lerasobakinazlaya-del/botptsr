...
def main() -> int:
    parser = argparse.ArgumentParser(description="Validate SMM content campaign config.")
    ...
    if errors:
        print("Content pipeline validation failed:")
        for error in errors:
            print(f"- {error}")
        return 1

    print("Content pipeline validation passed.")
    return 0
